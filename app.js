const directory = {
  ...
  browser: [
    ...
    },
    {
      ...
      logo: "apps/Mullvad_Browser_logo.svg.png",
      github: "https://gitlab.torproject.org/tpo/applications/mullvad-browser",
  ...
  calendar: [
    ...
    },
    {
      ...
      fdroid: "https://f-droid.org/packages/org.fossify.calendar/",
  ...
  password: [
    {
      name: "Bitwarden",
      logo: "apps/bitwarden-icon.png",
      github: "https://github.com/bitwarden",
      fdroid: "https://mobileapp.bitwarden.com/fdroid/repo",
      website: "https://bitwarden.com/",
    },
    {
      name: "KeePassXC",
      logo: "apps/keepassxc.png",
  ...
  search: [
    ...
    },
    {
      name: "Kagi Search",
      logo: "apps/kagi.webp",
      github: "https://github.com/kagisearch",
      fdroid: "",
      website: "https://kagi.com/",
    },
    {
      name: "Mojeek",
      logo: "apps/mojeek.svg",
      github: "",
      fdroid: "",
  ...
  social: [
    ...
    },
    {
      ...
      fdroid: "https://f-droid.org/packages/org.joinmastodon.android/",
      website: "https://joinmastodon.org/",
    },
    {
      name: "Pixelfed",
      logo: "apps/pixelfed.png",
...
function renderCategory(categoryName, containerId) {
  ...
  directory[categoryName].forEach((app) => {
    const card = document.createElement("div");
    card.className = "tool-card";

    card.innerHTML = `
      <img src="${app.logo}" class="tool-logo">
      <h3>${app.name}</h3>
      <div class="social-links">
        ${app.github ? `<a href="${app.github}" target="_blank" rel="noopener noreferrer" class="btn-pill"><img src="medias/githbub.svg" class="btn-icon"></a>` : ""}
        ${app.fdroid ? `<a href="${app.fdroid}" target="_blank" rel="noopener noreferrer" class="btn-pill"><img src="medias/fdroid.svg" class="btn-icon"></a>` : ""}
        ${app.website ? `<a href="${app.website}" target="_blank" rel="noopener noreferrer" class="btn-pill"><img src="medias/link.svg" class="btn-icon"></a>` : ""}
      </div>
    `;
